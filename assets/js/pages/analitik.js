...
function renderTabGlobal() {
    ...
    chartInstances.cGender = new Chart(document.getElementById("c-gender"), {
        ...
        data: {
            ...
            datasets: [{ data: Object.values(genderCount), backgroundColor: ["#1F9259", "#DB3F31"] }],
        },
    ...
    chartInstances.cKat = new Chart(document.getElementById("c-kategori"), {
        ...
        data: {
            ...
            datasets: [{ data: Object.values(catCount), backgroundColor: ["#1F9259", "#F58F0B", "#9C9478"] }],
        },
        options: { maintainAspectRatio: false, plugins: { legend: { position: "bottom" } } },
    });
    ...
    chartInstances.cU = new Chart(document.getElementById("c-usia"), {
        ...
        data: {
            ...
            datasets: [{ label: "Jumlah", data: Object.values(ageCount), backgroundColor: "#3FAE73", borderRadius: 4 }],
        },
    ...
    chartInstances.cTrend = new Chart(document.getElementById("c-trend-global"), {
        ...
        data: {
            labels: DIMENSI_LIST,
            datasets: [
                { label: "Pre-Test", data: avgPre, borderColor: "#F58F0B", fill: false, tension: 0.3 },
                { label: "Post-Test", data: avgPost, borderColor: "#1F9259", fill: false, tension: 0.3 },
            ],
        },
    ...
    chartInstances.cRadarG = new Chart(document.getElementById("c-radar-global"), {
        ...
        data: {
            labels: DIMENSI_LIST,
            datasets: [
                { label: "Pre-Test", data: avgPre, borderColor: "#F58F0B", backgroundColor: "rgba(245, 143, 11, 0.15)" },
                {
                    label: "Post-Test",
                    data: avgPost,
                    borderColor: "#1F9259",
                    backgroundColor: "rgba(31, 146, 89, 0.15)",
                },
            ],
        },
        options: { maintainAspectRatio: false },
            ...
            datasets: [
                {
                    ...
                    backgroundColor: ["#1F9259", "#F58F0B", "#DB3F31"],
                },
            ],
        },
            ...
            datasets: [
                {
                    ...
                    backgroundColor: ["#CDC6AC", "#9C9478", "#3FAE73", "#1F9259"],
                    borderRadius: 4,
                },
            ],
        },
            ...
            datasets: [
                {
                    ...
                    data: preData,
                    borderColor: "#F58F0B",
                    backgroundColor: "rgba(245, 143, 11, 0.15)",
                },
                {
