...
async function loadDataProfil() {
    try {
        ...
        // Cincin & lencana level di kartu identitas
        const { level, persen } = hitungLevel(profil.total_poin || 0);
        document.getElementById("profil-level").innerText = level;
        document.getElementById("ring-level-profil").style.setProperty("--progres", persen);
    } catch (e) {
        ...
        if (validTopics.length === 0) {
            ...
            chartInstances["prepost"] = new Chart(document.getElementById("chartPrePost").getContext("2d"), {
                ...
                data: {
                    ...
                    datasets: [
                        { label: "Nilai Pre-Test", data: dataPre, backgroundColor: "#F58F0B", borderRadius: 6 },
                        { label: "Nilai Post-Test", data: dataPost, backgroundColor: "#1F9259", borderRadius: 6 },
                    ],
                },
                options: {
                    responsive: true,
                ...
                datasets: [
                    {
                        ...
                        data: trendXP,
                        borderColor: "#DB3F31",
                        backgroundColor: "rgba(219, 63, 49, 0.1)",
                        fill: true,
                        tension: 0.4,
                        yAxisID: "y",
                    },
